...
class User(db.Model):
    ...
    def __repr__(self):
        ...
        return"<user_id={}, email={}, password={}, age={}, zipcode={}>".format(
...
class Movie(db.Model):
    ...
    def __repr__(self):
        ...
        return "<movie_id={}, title={}, released_at={}, imdb_url={}>".format(
            self.movie_id, self.title, self.released_at, self.imdb_url)

class Rating(db.Model):
    """Ratings information.
    Joins Users and Movies and stores corresponding ratings. """
    ...
    def __repr__(self):
        ...
        return "<rating_id={}, movie_id={}, user_id={}, score={}>".format(
